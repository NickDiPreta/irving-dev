...
var Home = function () {
  ...
  var _a = framer_motion_1.useCycle(
      'Rent',
      'Netflix',
      'Hulu',
      'Spotify',
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'left-one' },
          React.createElement(StaticText_1.StaticText, {
          ...
          React.createElement(
            ...
            show &&
              React.createElement(RevolvingText_1['default'], { text: text })
          ),
          React.createElement(Subtitle_1.Subtitle, {
            text:
      ...
      React.createElement(
        'div',
        { className: 'blockTwo' },
        React.createElement(OverviewBlock_1.OverviewBlock, {
          image: '/static/icons-oc-setup.png',
          text: 'Quick & Easy Setup',
          subtext:
            'Start your credit building journey in as little as 5 minutes',
        }),
        React.createElement(OverviewBlock_1.OverviewBlock, {
          image: '/static/icons-oc-credit.png',
          text: 'Automate credit building',
          subtext:
            'Increase your score month to month without changing your lifestyle',
        }),
        React.createElement(OverviewBlock_1.OverviewBlock, {
          image: '/static/icons-oc-secure.png',
          text: 'Keep all your information safe',
          subtext:
